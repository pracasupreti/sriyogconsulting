          ...
          <div className=" mx-auto relative px-[10px] container ">
            ...
            <div className="mb-[50px] relative  min-h-[100px] rounded ">
              ...
              <div className="w-[45%] bg-[#efefef]  pb-[20px] ml-auto rounded relative mt-10 max-md:ml-auto max-md:mr-0 max-md:w-[80%] max-lg:ml-auto max-lg:mr-0 max-lg:w-[80%]">
                ...
                <a href="https://apps.apple.com/np/app/sriyog/id1493160529" className="bg-[#055d59] text-[#fff] cursor-pointer font-medium text-center py-2 px-4 ml-2 inline-block rounded">
                  Download App
                </a>
              </div>
            ...
            <div className="mb-[50px] relative min-h-[100px] rounded ">
              ...
              <div className="w-[45%] bg-[#efefef]  pb-[20px] mr-auto rounded relative mt-10 max-md:ml-auto max-md:mr-0 max-md:w-[80%] max-lg:ml-auto max-lg:mr-0 max-lg:w-[80%]">
                ...
                <a href="https://sriyog.com/app/" className="bg-[#055d59] text-[#fff] cursor-pointer font-medium text-center py-2 px-4 inline-block ml-2 rounded">
                  View App
                </a>
              </div>
            </div>
            ...
            <div className="mb-[50px] relative min-h-[100px]">
              ...
              <div className="w-[45%] bg-[#efefef]  pb-[20px] mr-auto rounded relative mt-10 max-md:ml-auto max-md:mr-0  max-md:w-[80%]  max-lg:ml-auto max-lg:mr-0 max-lg:w-[80%]">
                ...
                <a href="https://play.google.com/store/apps/details?id=com.pracasinfosys.sriyog.com" className="bg-[#055d59] text-[#fff] cursor-pointer font-medium text-center py-2 px-4 rounded ml-2">Browse</a>
              </div>
            </div>
            <div className="mb-[50px] relative min-h-[100px]">
              <div className="max-md:left-[10%] max-lg:left-[10%]   bg-[#055d59] w-[50px] h-[50px] text-[23px] text-white text-center absolute top-0 left-[50%] -translate-x-1/2 overflow-hidden rounded-full flex items-center justify-center">
              ...
              <div className="w-[45%] bg-[#efefef]  pb-[20px] ml-auto rounded relative mt-10 max-md:ml-auto max-md:mr-0  max-md:w-[80%]  max-lg:ml-auto max-lg:mr-0 max-lg:w-[80%]">
                ...
                <a href="htttps://play.google.com/store/apps/details?id=com.pracasinfosys.sriyog.com" className="bg-[#055d59] text-[#fff] cursor-pointer font-medium text-center py-2 px-4 inline-block rounded ml-2">
                  Browse
                </a>
              </div>
            </div>
            ...
            <div className="mb-[50px] relative min-h-[100px]">
              ...
              <div className="w-[45%] bg-[#efefef]  pb-[20px] ml-auto rounded relative mt-10 max-md:ml-auto max-md:mr-0  max-md:w-[80%]  max-lg:ml-auto max-lg:mr-0 max-lg:w-[80%]">
                ...
                <a href="htttps://play.google.com/store/apps/details?id=com.pracasinfosys.sriyog.com" className="bg-[#055d59] text-[#fff] cursor-pointer font-medium text-center inline-block ml-2 py-2 px-4 rounded">
                  Browse
                </a>
              </div>
            </div>
