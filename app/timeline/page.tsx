...
import { FaFlask, FaLocationDot, FaRocket } from "react-icons/fa6";
          ...
          <div className=" mx-auto relative px-[10px] container ">
            ...
            <div className="mb-[50px] relative  min-h-[100px] rounded ">
              ...
              <div className="w-[45%] bg-[#efefef]  pb-[20px] ml-auto rounded relative mt-10 max-md:ml-auto max-md:mr-0 max-md:w-[80%] max-lg:ml-auto max-lg:mr-0 max-lg:w-[80%]">
                ...
                <a href="https://apps.apple.com/np/app/sriyog/id1493160529" className="bg-[#055D59] hover:bg-[#2e5453] text-white transition-all duration-300 ease-in-out cursor-pointer font-medium text-center inline-block ml-2 py-2 px-6 rounded-md ">
                  Download App
                </a>
              </div>
            ...
            <div className="mb-[50px] relative min-h-[100px] rounded ">
              ...
              <div className="w-[45%] bg-[#efefef]  pb-[20px] mr-auto rounded relative mt-10 max-md:ml-auto max-md:mr-0 max-md:w-[80%] max-lg:ml-auto max-lg:mr-0 max-lg:w-[80%]">
                ...
                <a href="https://sriyog.com/app/" className="bg-[#055D59] hover:bg-[#2e5453] text-white transition-all duration-300 ease-in-out cursor-pointer font-medium text-center inline-block ml-2 py-2 px-6 rounded-md ">
                  View App
                </a>
              </div>
            </div>
            ...
            <div className="mb-[50px] relative min-h-[100px]">
              ...
              <div className="w-[45%] bg-[#efefef]  pb-[20px] mr-auto rounded relative mt-10 max-md:ml-auto max-md:mr-0  max-md:w-[80%]  max-lg:ml-auto max-lg:mr-0 max-lg:w-[80%]">
                ...
                <a href="https://play.google.com/store/apps/details?id=com.pracasinfosys.sriyog.com" className="bg-[#055D59] hover:bg-[#2e5453] text-white transition-all duration-300 ease-in-out cursor-pointer font-medium text-center inline-block ml-2 py-2 px-6 rounded-md ">Browse</a>
              </div>
            </div>
            <div className="mb-[50px] relative min-h-[100px]">
              <div className="max-md:left-[10%] max-lg:left-[10%]   bg-[#055D59] w-[50px] h-[50px] text-[23px] text-white text-center absolute top-0 left-[50%] -translate-x-1/2 overflow-hidden rounded-full flex items-center justify-center">
              ...
              <div className="w-[45%] bg-[#efefef]  pb-[20px] ml-auto rounded relative mt-10 max-md:ml-auto max-md:mr-0  max-md:w-[80%]  max-lg:ml-auto max-lg:mr-0 max-lg:w-[80%]">
                ...
                <a href="htttps://play.google.com/store/apps/details?id=com.pracasinfosys.sriyog.com" className="bg-[#055D59] hover:bg-[#2e5453] text-white transition-all duration-300 ease-in-out cursor-pointer font-medium text-center inline-block ml-2 py-2 px-6 rounded-md ">
                  Browse
                </a>
              </div>
            </div>
            ...
            <div className="mb-[50px] relative min-h-[100px]">
              ...
              <div className="w-[45%] bg-[#efefef]  pb-[20px] ml-auto rounded relative mt-10 max-md:ml-auto max-md:mr-0  max-md:w-[80%]  max-lg:ml-auto max-lg:mr-0 max-lg:w-[80%]">
                ...
                <p className="mt-[20px] block my-4 ml-0 p-2"> Office shifted to Kathmandu - 3<sup>rd</sup> March, 2025</p>
                <p className="block my-4 ml-0 mb-[1rem] p-2">
                  SRIYOG App has a new homepage - 12<sup>th</sup> May, 2025  
                  <br /><br />
                  Location updated on OCR - 15<sup>th</sup> May, 2025 
                </p>
                <a href="https://sriyog.app" className="bg-[#055D59] hover:bg-[#2e5453] text-white transition-all duration-300 ease-in-out cursor-pointer font-medium text-center inline-block ml-2 py-2 px-6 rounded-md ">
                  Browse
                </a>
              </div>
            </div>
