...
const Tos = () => {
  return (
    <>
      <Ribbon name="Terms of Services" des="" />
      <section className="mb-[45px] mx-auto max-lg:container max-lg:px-3 lg:w-[1180px] max-md:shadow-none border max-md:border-none border-[#dbdbdb] ">
        <div className=" p-[55px] max-md:p-0 ">
          ...
          <p className=" mb-[10px]">
            ...
            professionals, and users who access or use the Service.
          </p>
          <p className=" mb-[56px] max-md:mb-[20px]">
            If you are accessing or using the service, it means that you agree
            to be bound by these Terms. If you disagree with any part of the
            terms, then we advise you to immediately stop using the service.
          </p>
          ...
          <p className=" mb-[10px]">
            You are yourself responsible to safeguard your account details like
            username and password.
          </p>
          <p className=" mb-[56px] max-md:mb-[20px]">
            You agree to keep your password safe and not to share it to any
            third party. If your account is compromised or in case of any
            security issue, you must notify us immediately.
          </p>
          ...
          <p className=" mb-[10px]">
            ...
            provided by the users. These users (including you) or any third
            party are independent contractors and are not related or affiliated
            to us in any way. As such, you agree not to hold us responsible for
            the violation, error, carelessness or breach of any of the Service
            or information listed on our website or mobile application.
          </p>
          <p>
          ...
          <p className=" mb-[56px] max-md:mb-[20px]">
            You agree that you cannot hold us responsible in case of any
            defaults from the providers. If you have any bad experience, please
            complain us about the particular Provider and we will take action to
          ...
          <p className=" mb-[56px] max-md:mb-[20px]">
            As such websites might have their own terms and condition unaware to
            us, we strongly recommend you to read their terms and conditions and
            privacy policies of such third-parties you visit.
          </p>
          ...
          <p className=" mb-[10px]">
            All the images, logo, text and content in our site are either your
            content, the content of SRIYOG or of the other users. You agree that
            they are the intellectual property of the respective owners and you
            shall not copy, modify, or distribute the content that is not owned
            by you.
          </p>
          <p className=" mb-[56px] max-md:mb-[20px]">
            Such contents are protected by the Intellectual Property Laws of
            Nepal Government and other international laws. You will be held
            liable in case of infringement of copyright.
          </p>
          <p className="text-[1.4rem] font-bold mb-[10px]">Termination</p>
          <p className=" mb-[10px]">
            If you breach our Terms, we may immediately terminate or suspend
            access to your account with or without prior notice. Upon
            termination, you will immediately lose access to our Service and
            your right to use our service will cease.
          </p>
          <p className=" mb-[10px]">
            If you voluntarily wish to terminate your account, you may contact
            us or simply discontinue using the Service.
          </p>
          <p className=" mb-[56px] max-md:mb-[20px]">
            Even after the termination of your account, you will be liable for
            the breach of the contract and legal actions may be taken against
            you.
          </p>
          <p className="text-[1.4rem] font-bold mb-[10px]">Governing Law</p>
          <p className=" mb-[10px]">
            If we fail to enforce any right or provision of these Terms, it does
            not mean that you have been provided a waiver of those rights.
          </p>
          <p className=" mb-[56px] max-md:mb-[20px]">
            If any provision of our Terms is in conflict with the Law of Nepal
            and held to be invalid or unenforceable by a court, the remaining
            provisions of these Terms will remain in effect. These Terms are the
            only terms between us that is applicable regarding our services and
            supersede and replace any other agreements prior to thus that we
          ...
          <p className=" mb-[10px]">
            The subject of changes in terms will be determined at our sole
            discretion.
          </p>
          <p className=" ">
            If you continue to use our Service after those changes become
            effective, it means that you agree to be abided by the revised
            terms. You should immediately cease to use the service if you do not
