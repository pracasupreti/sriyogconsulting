      ...
      <div className="max-w-[1180px] mx-auto my-0  lg:my-0  md:mx-auto md:my-0  py-14 sm:px-0">
        <div className="grid md:grid-cols-2 p-10 bg-[#0D5D59] rounded-lg sm:flex-row sm:justify-center sm:p-8 lg:gap-0 md:gap-5 md:flex-row  lg:p-8 lg:justify-between lg:items-center">
          ...
          <div className="inline basis-[17%]">
           <Image src={"/assets/images/about/teamw.svg"} width={66} height={66} alt="experienced_team" className="color-white"/>
          </div>

          <div className="inline basis-[80%]">
            <h2 className="inline-block text-white text-[18px] pb-1">Experienced Team</h2>
            <p className="text-white">Deliver high-quality and reliable IT services that help businesses thrive in a digital-first world.</p>
          ...
          <div className="inline basis-[17%]">
           <Image src={"/assets/images/about/buildingw.svg"} width={66} height={66} alt="experienced_team"/>
          </div>
          ...
          <div className="inline basis-[17%]">
           <Image src={"/assets/images/about/flagw.svg"} width={66} height={66} alt="experienced_team"/>
          </div>
          ...
          <div className="inline basis-[17%]">
           <Image src={"/assets/images/about/skillsw.svg"} width={66} height={66} alt="experienced_team"/>
          </div>
