...
export default function InternshipForm() {
  ...
  const handlePhoneChange = (value: string, name: "phone" | "emergencyPhone") => {
    setFormData((prev) => ({ ...prev, [name]: value }));
  };
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1">
            ...
            <PhoneInput
              ...
              inputStyle={{ width: "100%", paddingLeft: "48px", fontSize: 16 }}
            ...
            <input
              ...
              type="text"
              placeholder={
                focusStates.semesterYear ? "" : "Enter current semester or passed year"
              }
              value={formData.semesterYear}
              onChange={handleChange}
              onFocus={() => setFocusStates({ ...focusStates, semesterYear: true })}
              onBlur={(e) =>
                setFocusStates({
                  ...focusStates,
            ...
            <input
              ...
              onChange={handleChange}
              onFocus={() => setFocusStates({ ...focusStates, college: true })}
              onBlur={(e) =>
                setFocusStates({
                  ...focusStates,
          ...
          <div className="flex-1">
            ...
            <input
              ...
              onChange={handleChange}
              onFocus={() => setFocusStates({ ...focusStates, semester: true })}
              onBlur={(e) =>
                setFocusStates({
                  ...focusStates,
            ...
            <input
              name="period"
              type="text"
              placeholder={focusStates.period ? "" : "Enter internship period"}
            ...
            <input
              ...
              type="text"
              placeholder={
                focusStates.emergencyContact ? "" : "Enter emergency contact person"
              }
              value={formData.emergencyContact}
              onChange={handleChange}
              onFocus={() => setFocusStates({ ...focusStates, emergencyContact: true })}
              onBlur={(e) =>
                setFocusStates({
                  ...focusStates,
            ...
            <input
              ...
              onChange={handleChange}
              onFocus={() => setFocusStates({ ...focusStates, relation: true })}
              onBlur={(e) =>
                setFocusStates({
                  ...focusStates,
            ...
            <PhoneInput
              ...
              inputProps={{ name: "emergencyPhone", required: true, autoFocus: false }}
              inputStyle={{ width: "100%", paddingLeft: "48px", fontSize: 16 }}
              placeholder="+977 98XXXXXXXX"
              enableSearch
              disableDropdown={false}
